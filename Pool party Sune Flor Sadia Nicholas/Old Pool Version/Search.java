...
public class Search implements ActionListener
{
   ...
   public void actionPerformed(ActionEvent event)
   {
      ...
      if(event.getSource() == search) //search member by name
      {
         ...
         else if (member.searchElite(nameField.getText()) > -1){ //if not a regular member search elite
         ...
         else{ //returns empty strings if member cant be found
