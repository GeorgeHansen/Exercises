...
public class MemberList {
   ...
   ArrayList<Member> memberList = new ArrayList<Member>(); // ArrayList of member
   ArrayList<Elite> eliteList = new ArrayList<Elite>();  // ArrayList of elite
   
   
 /*  public void createNewMember(Member member){
      System.out.println("adding regular member");
      memberList.add(member);//to add a new member to the list
   }*/
