...
public class Member {
   ...
   public void printMember() //prints to console. Only for testing
   {
   ...
   public int calculateAge(String date) //calculates age based on birthdate and current date
   {
   ...
   public void writeMember(PrintStream output) // write member to file
   {
      output.print("Member\n");
   ...
   public void readMember(Scanner input) //read from file
   {
      //input.nextLine();
